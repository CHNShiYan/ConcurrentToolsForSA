...
public class task_dReducer extends Reducer<Text, Text, task_dTool, task_dTool>{

	@Override
	protected void setup(Reducer<Text, Text, task_dTool, task_dTool>.Context context)
	...
	@Override
	protected void cleanup(Reducer<Text, Text, task_dTool, task_dTool>.Context context)
			throws IOException, InterruptedException {
		// TODO Auto-generated method stub
	...
	protected void reduce(Text key, Iterable<Text> values,
			Reducer<Text, Text, task_dTool, task_dTool>.Context content) throws IOException, InterruptedException {
		// TODO Auto-generated method stub
		...
		for(String type : cnt.keySet()){
			...
			content.write(new task_dTool(String.valueOf(key),type,average),null);
		}
	}
